  ...
  <div class="container">
    ...
    >
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="staticBackdropLabel">Обновить</h5>
            <button
              type="button"
              class="btn-close"
              data-bs-dismiss="modal"
    ...
    >
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="staticBackdropLabel">Удалить товар</h5>
            <button
              type="button"
              class="btn-close"
              data-bs-dismiss="modal"
          ...
          <div class="modal-body">
            ...
            <!-- form start here -->
            <form>
              <h3>Вы действительно хотите удалить позицию ?</h3>
              <br />
