          ...
          <div class="col">
            <div class="table-responsive">
              <table class="table">
                <thead>
                  <tr>
                    <th scope="col" class="h5">Корзина покупок</th>
            ...
            <div class="card-body p-4">
              <div class="row">
                <div class="col-lg-4 col-xl-3">
                  ...
                  >
                    <p class="mb-2">Промежуточный итог</p>
                  ...
                  <div
                    ...
                    style="font-weight: 500"
                  >
                    <p class="mb-2">Всего (Включая доставку)</p>
      ...
      <div class="modal-content" style="border: black">
        <div class="modal-header" style="background: #242121; color: white">
          <div class="r" style="display: flex; margin: auto">
            ...
            <h5 class="modal-title" id="exampleModalLabel">
              Вам необходимо сначала аутентифицироваться!
            </h5>
          </div>
        </div>
        <div class="modal-body" style="display: flex">
